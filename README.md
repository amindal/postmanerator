...
Just download the [latest release on Github](https://github.com/amindal/postmanerator/releases/latest). You obviously need to pick the right binary depending on your environment. Then place that binary somewhere in your system that is in your PATH, you might want to rename it to simply `postmanerator`.
...
You can either provide a theme name from the [official themes repository](https://github.com/amindal/postmanerator-themes), or a full local path to theme folder.
...
You can either specify the name of one of the themes that are indexed in the [official themes repository](https://github.com/amindal/postmanerator-themes), or either specify a full URL pointing to git repository. Moreover the `-theme-local-name` option allows you to change the name of your local copy of the theme. Please see the following examples.
...
postmanerator themes get https://github.com/amindal/postmanerator-markdown-theme.git # will clone the given repository under your local themes directory, in a folder named 'postmanerator-markdown-theme'
postmanerator -theme-local-name="markdown" themes get https://github.com/amindal/postmanerator-markdown-theme.git # will clone the given repository under your local themes directory, in a folder named 'markdown'
```
...
As said in the introduction, the easiest way to get it installed for now is to download the latest appropriate [release on Github](https://github.com/amindal/postmanerator/releases/latest), depending on your system. Then copy it somewhere in your PATH, renaming it to `postmanerator`.
...
- Download Postmanerator using go get: `go get github.com/amindal/postmanerator`
